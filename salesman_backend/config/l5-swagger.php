...
return [
    ...
    'documentations' => [
        'default' => [
            ...
            'paths' => [
                ...
                /*
                 * Absolute path to the directory where the generated documentation files will be stored
                 */
    ...
    'defaults' => [
        ...
        */
         ...
         */
        'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'http://salesman_backend.test'),
        ],
    ],
];
